            ...
            <Card className="py-4 mt-6">
                <CardHeader className="pb-0 pt-2 px-4 items-start justify-between">
                    <div className="flex gap-5">
                        <div className="flex flex-col gap-1 items-start justify-center">
                            <h4 className="text-large font-semibold leading-none text-default-600">{data.name},</h4>
                    ...
                    <Suspense fallback={<Loading/>}>
                        <LikeButton from_user_id={params.users} to_user_id={data.telegram_id}/>
                    </Suspense>
                </CardHeader>
                <CardBody className="overflow-visible py-2 items-center justify-center">
                    <Image
                        ...
                        src={data.photo} // Використовуйте фото з API
                        width={270}
                    />
                </CardBody>
                {data.about !== 'NULL' && (
